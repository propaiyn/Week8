...
public class TestCalcChain {
	...
	public static void main(String[] args){
		...
		Chain chainCalc1 = new AddNumbers();  //creating chain objects
		...
		chainCalc1.setNextChain(chainCalc2); //data forwarding 
		...
		Numbers request = new Numbers(21,2,"div"); // creates a new numbers object
		
		chainCalc1.calculate(request); //object is passed to the first in the chain
