package DesignPatterns.Creational.SingletonEx;

import java.util.Arrays;
import java.util.Collections; //Jumble linked list letters
import java.util.LinkedList;

public class Singleton {
	
	private static Singleton firstInstance = null; //holds only instance of Singleton

    //Access point for object created from class; static as it needs to be globbaly availiable
    ...
    //Letters in array are put into a linked list
	...
	private Singleton() { } //constructor (one instance for singleton)
	...
	public static Singleton getInstance() {
		if(firstInstance == null) { //check if instance exists
			...
			synchronized(Singleton.class){ 
				...
				if(firstInstance == null) { //checks if instance exists
		...
		return firstInstance; //Either way, instance is returned
	}
